...
from utils.volume_stats import Dice3d, Jaccard3d, Sens3d, Spec3d
...
class UNetExperiment:
    ...
    def __init__(self, config, split, dataset):
        ...
        # Create data loaders
        # SlicesDataset class is completed. 
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # We have data in batch variable. Put the slices as 4D Torch Tensors of 
            ...
            # ANSWER: Dimensions of variable prediction:
            # 0: BATCH SIZE; 
            # 1: Label Class; 
            # 2: Image dimention 1 SIZE (WIDTH); 
            # 3: Image dimention 2 SIZE (HEIGHT). 
    ...
    def run_test(self):
        ...
        # Complete Inference Agent. Feel free to test the class
        ...
        for i, x in enumerate(self.test_data):
            ...
            # Implement Dice3D and Jaccard3D functions. 
            ...
            sens = Sens3d(pred_label, x["seg"])
            spec = Spec3d(pred_label, x["seg"])
