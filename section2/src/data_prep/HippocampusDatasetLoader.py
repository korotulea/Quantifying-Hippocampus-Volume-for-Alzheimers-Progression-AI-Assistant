...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # Use med_reshape function to reshape images
        ...
        # ANSWER: The label represents a ground truth class (could be more than 2), 
        # and depend on the model architecture, class can be coded as an integer (use as it is) 
        # or further transformed using one-hot encoding
